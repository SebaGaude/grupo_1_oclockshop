// // Validacion Trabaja con Nosotros //

const form = document.querySelector(".form-extras");
const email = document.querySelector(".email-workwitus");
const submit = document.querySelector(".boton-crear-cuenta")

form.addEventListener("submit", (e)=>{

    alert("¡Gracias por enviarnos tu CV! Nos comunicaremos contigo en la brevedad");
